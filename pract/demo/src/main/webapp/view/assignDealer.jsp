...
<html>
<head>
	<title>Pending Orders (For Admin)</title>
</head>
...
<div class="pendingOrder">
  ...
  for (PlaceOrder placeOrder : pl) {
	...
	out.write("<tr>"+"<td>"+count+"</td>"+"<td>"+placeOrder.getCurrentDate()+"</td>"+"<td>"+placeOrder.getCustomerName()+"</td>"+"<td>"+placeOrder.getProductName()+"</td>"+"<td>"+placeOrder.getQuantity()+"</td>"+"<td>"+placeOrder.getDeliveryAddress()+"</td>"+"</tr>");
	  count++;
